...
{
    public partial class Rel_Irrigacoes_Parametros : Form
    {
        public Rel_Irrigacoes_Parametros()
        {
            InitializeComponent();
        ...
        private void btn_visualizar_Click(object sender, EventArgs e)
        {
            ...
            string P_DATA_INI = txt_data_ini.Value.ToString("dd/MM/yyyy HH:mm:ss");
            string P_DATA_FIM = txt_data_fim.Value.ToString("dd/MM/yyyy HH:mm:ss");

            //Instancia o form do contrato.
            Rel_Irrigacoes_View Rel_Irrigacoes_View = new Rel_Irrigacoes_View(P_ID_AREA, P_ID_AREA_TODOS, P_DATA_INI, P_DATA_FIM);
            Rel_Irrigacoes_View.Owner = this;
            ...
            Rel_Irrigacoes_View.ShowDialog();
        }
        ...
        private void bunifuImageButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                System.Diagnostics.Process.Start(pasta + "\\Manuais\\relatorio_irrigacoes.pdf");
            }
            catch (MySql.Data.MySqlClient.MySqlException ex)
            {
                MessageBox.Show(ex.Message);
